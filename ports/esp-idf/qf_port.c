                      ...
                      uint_fast16_t const margin, enum_t const sig)
{
    ...
    portENTER_CRITICAL_ISR(&QF_esp32mux);
    Q_REQUIRE_NOCRIT_(700, idx < QF_priv_.maxPool_);
    portEXIT_CRITICAL_ISR(&QF_esp32mux);
...
void IRAM_ATTR QF_gcFromISR(QEvt const * const e) {
    ...
    if (QEVT_POOLID_(e) != 0U) {
        ...
        // this is the last reference to this event, recycle it
            ...
            QS_BEGIN_PRE_(QS_QF_GC, (uint_fast8_t)QEVT_POOLID_(e))
                QS_TIME_PRE_();         // timestamp
                QS_SIG_PRE_(e->sig);    // the signal of the event
                QS_2U8_PRE_(QEVT_POOLID_(e), e->refCtr_);//pool-Id&ref-Count
            QS_END_PRE_()
            ...
            Q_ASSERT_NOCRIT_(810, idx < QF_priv_.maxPool_);
                        ...
                        uint_fast8_t const qs_id)
{
    ...
    if (me->nFree > (QMPoolCtr)margin) {
        ...
        Q_ASSERT_NOCRIT_(900, fb != (QFreeBlock *)0);
        ...
        if (me->nFree == (QMPoolCtr)0) {
            ...
            Q_ASSERT_NOCRIT_(920, fb_next == (QFreeBlock *)0);
