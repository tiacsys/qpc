...
// Static, immutable (const) reserved events that the QEP event processor
// sends to state handler functions of QHsm-style state machine to execute
    ...
    uint_fast8_t const qs_id)
{
    ...
    Q_REQUIRE_ID(302, (QEvt_verify_(e))
                      && (s != Q_STATE_CAST(0))
