...
bool QXThread_delay(uint_fast16_t const nTicks) {
    ...
    Q_REQUIRE_INCRIT(801, QXK_priv_.lockHolder != thr->super.prio);
...
QEvt const * QXThread_queueGet(uint_fast16_t const nTicks) {
    ...
    Q_REQUIRE_INCRIT(500, (!QXK_ISR_CONTEXT_())
        ...
        && (thr->super.super.temp.obj == (QMState *)0));
    // - the thread must NOT be holding a scheduler lock.
    Q_REQUIRE_INCRIT(501, QXK_priv_.lockHolder != thr->super.prio);
...
void QXThread_block_(QXThread const * const me) {
    ...
    Q_REQUIRE_INCRIT(600, (QXK_priv_.lockHolder != me->super.prio));
